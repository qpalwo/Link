        ...
        GenerationAdapter generationAdapter = new GenerationAdapter(userList, new GenerationAdapter.AvatorClickListener() {
            ...
            void click(View v, int position) {
                if (holder.isExpanded) {
                    TranslateAnimation mHiddenAction = new TranslateAnimation(Animation.RELATIVE_TO_SELF, 0.0f, Animation.RELATIVE_TO_SELF, -1.0f, Animation.RELATIVE_TO_SELF, 0.0f, Animation.RELATIVE_TO_SELF, 0.0f);
                    ...
                    holder.addrelation.setOnClickListener(a -> {
                        ...
                        final View dialogView = LayoutInflater.from(mContext).inflate(R.layout.relation_dialog, null);
                        ImageView back = dialogView.findViewById(R.id.back_dialog);
                        Button finish = dialogView.findViewById(R.id.finish_relation);
                        EditText nameEdit = dialogView.findViewById(R.id.relation_name_edit);
                        ...
                        finish.setOnClickListener(view -> {
                            if (TextUtils.isEmpty(nameEdit.getText().toString())) {
                                Toast.makeText(mContext, "name can't be null", Toast.LENGTH_SHORT).show();
                                return;
                            }
                            int newPosition = 0;
